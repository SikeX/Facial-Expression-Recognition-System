...
# 创建VideoCapture对象
#video = "http://admin:123456@192.168.191.3:8081"
...
while True:
    ...
    faceLands = cascade.detectMultiScale(gray, scaleFactor=1.1,
                                         minNeighbors=3, minSize=(225, 225),maxSize=(1080,1080))
    ...
    if len(faceLands) > 0:
        for faceLand in faceLands:
            ...
            cv2.putText(frame, '%s' % emotion, (x, y + 10),
                        cv2.FONT_HERSHEY_DUPLEX, 1, (255, 255, 255), 2, 30)
